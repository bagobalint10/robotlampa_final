 ...
 */ 
 ...
 void motor_1_init(void)
 {
	...
	set_timer_int_Callback(TIMER1,motor_update_timer);				

	PORT_Init(&MOTOR_1_PULSE_DIR,MOTOR_1_PULSE_PIN, OUTPUT);		
	PORT_Init(&MOTOR_1_DIR_DIR,MOTOR_1_DIR_PIN, OUTPUT); 			
 }
